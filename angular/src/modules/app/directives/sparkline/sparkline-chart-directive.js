'use strict';
angular.module('patternfly.pf-components').directive('pfSparklineChart', ['ChartsMixin', '$timeout', function(chartsMixin, $timeout) {
    return {
        restrict: 'A',
        scope: {
            config: '=',
        ...
        replace: true,
        templateUrl: 'modules/app/directives/sparkline/sparkline-chart.html',
