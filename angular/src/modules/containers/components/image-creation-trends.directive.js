'use strict';
angular.module('cfme.containersModule').directive('cfmeImageTrends', ['ChartsMixin', '$timeout', function(chartsMixin, $timeout) {
    return {
        restrict: 'A',
        scope: {
            data: '=',
        ...
        replace: true,
        templateUrl: 'modules/containers/components/image-creation-trends.directive.html',
