 ...
 * @example
 ...
 <file name="script.js">
 angular.module( 'patternfly.card' ).controller( 'CardDemoCtrl', ['$scope', function( $scope ) {
    $scope.status = {
      "title":"Nodes",
      "count":793,
      "href":"#",
...
angular.module( 'cfme.patternfly.card' ).directive('pfAggregateStatusCard', function () {
  'use strict';
  return {
    restrict: 'A',
    scope: {
